...
const AvatarModal = ({ isOpen, onClose, user, onAvatarUpdated }) => {
  const [saving, setSaving] = useState(false);
  
  if (!isOpen) return null;

  // Generate 50 bottts seeds for tech-themed avatars
  const avatars = Array.from({ length: 50 }, (_, i) => `https://api.dicebear.com/7.x/bottts/svg?seed=AvatarBot${i + 1}&backgroundColor=e2e8f0,bbf7d0,c7d2fe,fbcfe8,fed7aa`);
