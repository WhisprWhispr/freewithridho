...
import { Shield, Eye, Scale, ArrowLeft, AlertTriangle, CheckCircle, XCircle, Info, Bell, Gift } from 'lucide-react';
      ...
      <div className="legal-container">
        ...
        <div className="legal-card">
          <div className="legal-header">
            ...
            <p>Berlaku efektif sejak: 1 Agustus 2026 · Versi 3.0</p>
          </div>
          <div className="legal-body">
            <div className="legal-notice">
              <AlertTriangle size={18} />
              <span>Dengan mendaftar dan menggunakan layanan FREEWITHRIDHO, Anda dianggap telah membaca, memahami, dan menyetujui seluruh ketentuan dalam Kebijakan Privasi ini secara penuh dan tanpa syarat.</span>
            </div>

            <section>
              <h2>1. Informasi yang Kami Kumpulkan</h2>
              <p>Kami mengumpulkan data yang Anda berikan secara sukarela saat mendaftar, bertransaksi, dan menggunakan fitur platform, meliputi:</p>
              <ul>
            ...
            <section>
              ...
              <ul>
                ...
                <li>Mengirimkan notifikasi platform (promo, flash sale, pengumuman penting) kepada pengguna terdaftar.</li>
                <li>Mengelola sistem referral dan penghitungan komisi afiliasi secara otomatis.</li>
                <li>Mendeteksi, menginvestigasi, dan mencegah aktivitas penipuan atau penyalahgunaan platform.</li>
                <li>Meningkatkan kualitas layanan melalui analisis penggunaan platform secara anonim dan agregat.</li>
              </ul>
            </section>
            ...
            <section>
              <h2>5. Notifikasi Platform</h2>
              <p>Platform ini menggunakan sistem notifikasi real-time. Dengan mendaftar, Anda menyetujui untuk menerima notifikasi dari platform yang mencakup:</p>
              <ul>
                <li>Pengumuman promo kode dan flash sale terbaru.</li>
                <li>Informasi pembaruan sistem dan kebijakan penting.</li>
                <li>Notifikasi transaksi dan status penarikan dana (khusus Partner).</li>
              </ul>
              <p>Anda dapat menutup panel notifikasi kapan saja, namun tidak dapat menonaktifkan penerimaan notifikasi sistem secara permanen selama akun aktif.</p>
            </section>
            ...
            <section>
              <h2>7. Kontak & Pertanyaan Privasi</h2>
      ...
      <div className="legal-container">
        ...
        <div className="legal-card">
          ...
          <div className="legal-body">
            <div className="legal-notice">
              <AlertTriangle size={18} />
              <span>Penggunaan platform FREEWITHRIDHO dalam bentuk apapun — termasuk mendaftar, membeli, menjual, atau sekadar menjelajahi — merupakan persetujuan penuh dan tidak bersyarat terhadap seluruh ketentuan di bawah ini. Jika Anda tidak menyetujui, segera hentikan penggunaan layanan kami.</span>
            </div>

            <section>
              <h2>1. Pendaftaran & Data Pengguna</h2>
              <p>Saat mendaftar, Anda wajib mengisi nama lengkap yang valid dan alamat email aktif. Anda dapat memasukkan kode referral dari pengguna lain saat pendaftaran untuk saling memberikan keuntungan melalui program afiliasi. Anda bertanggung jawab penuh atas keakuratan data yang Anda berikan dan keamanan kata sandi akun Anda.</p>
            </section>

            <section>
              <h2>2. Lisensi Penggunaan Produk Digital</h2>
              ...
              <div className="legal-warning-box danger">
                <XCircle size={16} />
                <span><strong>DILARANG KERAS:</strong> Mendistribusikan ulang produk dalam bentuk aslinya (tanpa modifikasi signifikan), membocorkan atau menyebarkan link unduhan kepada pihak ketiga, menjual kembali produk secara langsung, atau mengunggah ulang ke platform lain tanpa izin tertulis dari pemilik. Pelanggaran ini dapat berakibat pada BAN PERMANEN dan/atau tuntutan hukum hak cipta.</span>
              </div>
            </section>

            <section>
              <h2>3. Kebijakan Partner Developer</h2>
              ...
              <div className="legal-warning-box danger">
                <XCircle size={16} />
                <span><strong>SANKSI PELANGGARAN:</strong> FREEWITHRIDHO memiliki otoritas mutlak untuk memberikan <strong>Suspensi Sementara</strong> atau <strong>Pemblokiran Permanen (BAN)</strong> terhadap akun Partner yang melanggar ketentuan ini. Saat di-ban: seluruh data akun, saldo pendapatan yang belum dicairkan, saldo komisi afiliasi, dan semua proyek akan <strong>dihapus dan dihanguskan secara permanen</strong> tanpa kompensasi dan tanpa hak banding.</span>
              </div>
            </section>

            <section>
              <h2>4. Sistem Lencana (Badge) Partner</h2>
              <p>Partner aktif akan menerima lencana (badge) secara otomatis berdasarkan total pendapatan kumulatif yang telah diraih:</p>
              <ul>
                <li><strong>🟢 Mitra Dasar</strong> — Total pendapatan ≥ Rp 1.000.000</li>
                <li><strong>🔵 Mitra Profesional</strong> — Total pendapatan ≥ Rp 2.000.000</li>
                <li><strong>🟣 Mitra Ahli</strong> — Total pendapatan ≥ Rp 5.000.000</li>
                <li><strong>💎 Mitra Elite</strong> — Total pendapatan ≥ Rp 10.000.000</li>
              </ul>
              <p>Lencana ditampilkan secara otomatis pada profil partner (privat dan publik) dan mencerminkan reputasi serta kepercayaan pembeli terhadap Partner tersebut. Lencana tidak dapat dibeli, hanya diraih melalui penjualan nyata.</p>
            </section>

            <section>
              <h2>5. Kebijakan Pengembalian Dana (No Refund Policy)</h2>
            ...
            <section>
              <h2>6. Program Afiliasi & Referral</h2>
              <p>Program afiliasi FREEWITHRIDHO memberikan komisi tetap kepada pemegang kode referral. Ketentuan:</p>
              <ul>
                <li>Kode referral dapat dimasukkan saat pendaftaran akun baru atau melalui halaman Profil.</li>
                <li>Komisi diberikan secara instan saat pengguna baru memasukkan kode referral Anda.</li>
                <li>Saldo komisi dapat dicairkan bersama saldo partner melalui mekanisme penarikan dana.</li>
                <li>FREEWITHRIDHO berhak mengubah nominal komisi sewaktu-waktu dengan pemberitahuan melalui notifikasi platform.</li>
            ...
            <section>
              <h2>7. Sistem Notifikasi Platform</h2>
              <p>Platform menggunakan sistem notifikasi real-time untuk menginformasikan promo, flash sale, dan pengumuman penting kepada seluruh pengguna terdaftar. Setiap pengguna memiliki status baca individual per notifikasi. Admin memiliki hak eksklusif untuk membuat dan menghapus notifikasi platform.</p>
            </section>

            <section>
              <h2>8. Pelepasan Tanggung Jawab (Disclaimer)</h2>
            ...
            <section>
              ...
              <p>FREEWITHRIDHO berhak memperbarui Syarat &amp; Ketentuan ini kapan saja. Perubahan signifikan akan diinformasikan melalui sistem notifikasi platform atau email terdaftar. Kelanjutan penggunaan layanan setelah perubahan dipublikasikan merupakan penerimaan terhadap ketentuan yang diperbarui.</p>
            </section>
          </div>
        </div>
      </div>
